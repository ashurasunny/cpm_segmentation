        ...
        for iter in range(1,201):
            ...
            for patient in data_list:
                ...
                for phase in ['ED', 'ES']:
                    ...
                    # instance_MSE += MSE(real_m_backup, fake_M)
                    # instance_diceM += np_categorical_dice_M(real_m_backup, fake_M)
            ...
            print('iteration{}:'.format(iter), instance_dice_ED, (instance_dice_ED[1] + instance_dice_ED[2] + instance_dice_ED[3]) / 3)
            print('iteration{}:'.format(iter), instance_dice_ES, (instance_dice_ES[1] + instance_dice_ES[2] + instance_dice_ES[3]) / 3)
